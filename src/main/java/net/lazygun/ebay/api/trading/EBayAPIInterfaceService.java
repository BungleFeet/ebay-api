 ...
 */
@WebServiceClient(name = "eBayAPIInterfaceService", targetNamespace = "urn:ebay:apis:eBLBaseComponents", wsdlLocation = "file:/C:/SDK/Java/V805_BUGFIX/build_area/source/wsdl/eBaySvc.wsdl")
public class EBayAPIInterfaceService
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/C:/SDK/Java/V805_BUGFIX/build_area/source/wsdl/eBaySvc.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/C:/SDK/Java/V805_BUGFIX/build_area/source/wsdl/eBaySvc.wsdl', retrying as a local file");
